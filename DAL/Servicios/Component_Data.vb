...
Public Class Component_Data
    Public Sub ObtenerComponents(ByRef obj As Component)
        ...
        For Each dr As DataRow In dt.Rows
            ...
            Else
                DirectCast(obj, Familia).AddComponent(New Patente(CInt(dr("ID")), CStr(dr("Nombre")), CStr(dr("Descripcion")), CInt(dr("Control_ID"))))
            End If
        Next
    End Sub
    ...
    Public Function ObtenerAllComponentes() As System.Collections.Generic.List(Of DTO.Component)
        Dim con As SqlConnection = Connection.GetObjConnextion
        ...
        For Each dr As DataRow In dt.Rows
            ...
            Else
                lst.Add(New Patente(CInt(dr("ID")), CStr(dr("Nombre")), CStr(dr("Descripcion")), CInt(dr("Control_ID"))))
            End If
        Next
