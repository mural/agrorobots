Public Class PaginasConocidas
    ...
    Public Shared ReadOnly POLITICAS As String = DIR_FRONT + "Piliticas" + ASPX

    'Acceso comun
    Public Shared ReadOnly INSTITUCIONAL As String = DIR_PAGES + "Institucional" + ASPX
    Public Shared ReadOnly BUSQUEDA As String = DIR_PAGES + "Busqueda" + ASPX
