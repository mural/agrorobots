<%@ Page Language="vb" ValidateRequest="False" AutoEventWireup="false" MasterPageFile="~/MenuBase.Master" CodeBehind="GananciasComparativas.aspx.vb" Inherits="Agorobots.GananciasComparativas" %>
...
<asp:Content ID="Body" ContentPlaceHolderID="BodyMenuContenido" runat="server">
    ...
    <br />
    <br />
    <asp:DropDownList ID="comboAno1" runat="server" AutoPostBack="False">
    </asp:DropDownList>
    <asp:DropDownList ID="comboMes1" runat="server" AutoPostBack="False">
    </asp:DropDownList>
    <br />
    <br />
    <asp:DropDownList ID="comboAno2" runat="server" AutoPostBack="False">
    </asp:DropDownList>
    <asp:DropDownList ID="comboMes2" runat="server" AutoPostBack="False">
    </asp:DropDownList>
    <br />
    <br />
